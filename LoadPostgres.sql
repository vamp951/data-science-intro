...
COPY Calendar FROM '$LOADDIR$/Calendar.txt'
...
COPY Campaigns FROM '$LOADDIR$/Campaigns.txt'
    WITH HEADER NULL 'NULL' DELIMITER '	' CSV;
...
COPY Customers FROM '$LOADDIR$/Customers.txt'
    WITH HEADER NULL 'NULL' DELIMITER '	' CSV;
...
COPY OrderLines FROM '$LOADDIR$/OrderLines.txt'
    WITH HEADER NULL 'NULL' DELIMITER '	' CSV;
...
COPY Orders FROM '$LOADDIR$/Orders.txt'
...
COPY Subscribers FROM '$LOADDIR$/Subscribers.txt'
    WITH HEADER NULL 'NULL' DELIMITER '	' CSV;
...
COPY ZipCensus FROM '$LOADDIR$/ZipCensus.txt'
...
COPY ZipCounty FROM '$LOADDIR$/ZipCounty.txt'
    WITH HEADER NULL 'NULL' DELIMITER '	' ENCODING 'LATIN1'  CSV;
